...
<body
	...
	<div class="page-wrapper">
		<jsp:include page="/include/admin/header-page.jsp"></jsp:include>

		<div class="page-container">
			<jsp:include page="/include/admin/menu-page.jsp"></jsp:include>
			<!-- start page content -->
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<spring:form action="doUpdateAccount" method="post"
									modelAttribute="user">
		...
		<jsp:include page="/include/admin/footer-page.jsp"></jsp:include>
	</div>
</body>
</html>